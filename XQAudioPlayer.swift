...
class XQAudioPlayer: UIView {
    ...
    var playingImage: UIImage! {
        ...
        get {
            return  UIImage(named: "podPauseIcon")
        }
    ...
    var pauseImage: UIImage! {
        get {
            return UIImage(named: "podPlayIcon")
        }
    ...
    func config(urlString: String) {
        ...
        // Init button play
        self.playButton = UIButton(frame: CGRect(x: -10, y: -2, width: playerWidth/5.0, height: playerHeight + 4.0))
        ...
        let slideView = UIView(frame: CGRect(x: playerWidth/8.0, y: 0, width: playerWidth*0.65, height: playerHeight))
...
//        progressBacground.addSubview(self.progressView)
        ...
        self.timeLabel = UILabel(frame: CGRect(x: 13/16.0*playerWidth, y: 0, width: playerWidth * 1/8.0 + 2, height: playerHeight ))
